function generaterdvCode(name, date,ville,quarter, pres,type){
    ...
    console.log(splited_date[2].slice(0,2))
    ...
    all_initials = (dateCode + initials + '/'+ initial_ville + initial_quartier + '/'+ initial_pres + initial_type).toUpperCase();
    console.log(all_initials.toLocaleUpperCase())
    return all_initials.toLocaleUpperCase();
}
//2023-07-21T00:33
generaterdvCode("Francine Madoh", "2023-07-21T00:33","Yaounde","Bonamoussadi", 
"Gold","Familial")
